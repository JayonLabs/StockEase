...
<head>
    ...
    <style>
        ...
        .info { background: #f9fafb; padding: 12px; border-radius: 6px; margin: 16px 0; }
        .info p { margin: 4px 0; }
        table { width: 100%; border-collapse: collapse; margin: 16px 0; }
        th { background: #f3f4f6; text-align: left; padding: 8px 12px; border-bottom: 2px solid #e5e7eb; }
        td { padding: 8px 12px; border-bottom: 1px solid #e5e7eb; }
        .total { background: #f0fdf4; border: 1px solid #86efac; border-radius: 6px; padding: 12px; margin: 16px 0; font-size: 18px; font-weight: bold; text-align: center; color: #166534; }
        .cash-info { background: #f9fafb; padding: 12px; border-radius: 6px; margin: 8px 0; }
...
<body>
    ...
    <div class="content">
        ...
        <p>Terima kasih telah berbelanja di <strong>{{ config('app.name') }}</strong>. Berikut adalah detail pembelian Anda:</p>
