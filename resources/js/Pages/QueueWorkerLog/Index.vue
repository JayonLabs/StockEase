...
const encodedStats = computed(() => {
    ...
    return {
        ...props.stats,
        file: props.stats.file,
        size: props.stats.size,
        modified: props.stats.modified,
        ...
        <template #breadcrumb>
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbPage>Queue Worker Logs</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
        </template>
